...
class TestFtLoad(unittest.TestCase):
    ...
    def test_01_load_image_success(self):
        ...
        self.assertIsNotNone(img_array, "L'image \
                             n'a pas été chargée correctement.")
        self.assertEqual(img_array.shape, (257, 450, 3), "La \
                         forme de l'image est incorrecte.")
    ...
    def test_02_image_not_found(self):
        ...
        self.assertIsNone(img_array, "Une \
                          image inexistante ne devrait pas être chargée.")
    ...
    def test_03_invalid_image_format(self):
        ...
        self.assertIsNone(img_array, "Le fichier \
                          texte ne devrait pas être chargé comme image.")
