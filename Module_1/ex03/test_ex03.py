...
class TestFtZoom(unittest.TestCase):
    ...
    def test_01_zoom_image_success(self):
        ...
        self.assertIsNotNone(zoomed_img, "L'image n'a pas été zoomée correctement.")
        self.assertEqual(zoomed_img.shape, (200, 200, 3), "La taille de l'image zoomée est incorrecte.")
    ...
    def test_02_image_not_found(self):
        ...
        self.assertIsNone(zoomed_img, "L'image inexistante ne devrait pas être zoomée.")
    ...
    def test_03_invalid_image_format(self):
        ...
        self.assertIsNone(zoomed_img, "Le fichier texte ne devrait pas être zoomé comme une image.")
