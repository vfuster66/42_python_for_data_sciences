...
class TestKing(unittest.TestCase):
    ...
    def test_01_initialization(self):
        print_title("Test ➜ Ex02 King Initialization")
    ...
    def test_02_set_eyes(self):
        print_title("Test ➜ Ex02 set_eyes() Method")
        joffrey = King("Joffrey")
    ...
    def test_03_set_hairs(self):
        print_title("Test ➜ Ex02 set_hairs() Method")
        joffrey = King("Joffrey")
    ...
    def test_07_inheritance(self):
        print_title("Test ➜ Ex02King Inheritance Check")
        joffrey = King("Joffrey")
